# Livestock Ecom Performance Dashboard
...
powershell -ExecutionPolicy Bypass -File scripts\export-dashboard-data.ps1 `
  -WorkbookPath "C:\Users\MeixiChen\Documents\ecom performance report\LS_Performance Dashboard_WK14.xlsx" `
...
```powershell
powershell -ExecutionPolicy Bypass -File scripts\export-dashboard-data.ps1 `
  -WorkbookPath "C:\path\LS_Performance Dashboard_WK14.xlsx","C:\path\LS_Performance Dashboard_WK15.xlsx" `
  -OutputPath "data\dashboard-data.json"
```
